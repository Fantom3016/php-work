        ...
        <div class="card">
            <div class="card-body">
                              ...
                              $_POST['weight'], $_POST['password']))
                    {
                        ...
                        */
                        ...
                        if (empty($file_error_message)) { 
                            ...
                            $query = "INSERT INTO exercise_user (user_name, first_name, "
                                    . "last_name, gender, birthdate, weight,"
                                    . "password_hash, image_file) "
                ...
                <form enctype="multipart/form-data" class="needs-validation" novalidate
                    ...
                    <div class="form-group row">
                        <label for="gender" 
                               class="col-sm-3 col-form-label-lg">Gender</label>
                        <div class="col-sm-8">
