...
<nav class="navbar sticky-top navbar-expand-md navbar-dark"
     style="background-color: #2a8cddff;">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <?php else: ?>
                <a class="nav-item nav-link
                    <?= $page_title == P_ADD_COLLECTION_PAGE ? ' active' : '' ?>"
                   href="addcollection.php">Log Collection</a>
                <a class="nav-item nav-link
                    <?= $page_title == P_COLLECTION_PAGE ? ' active' : '' ?>"
                   href="collection.php">Full Set</a>
                <a class="nav-item nav-link"
