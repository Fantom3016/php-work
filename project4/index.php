        ...
        <div class="card">
            <div class="card-body">
                <?php
                    ...
                    $query = "SELECT id, user_name FROM player ORDER BY user_name";
                ...
                <h3>This site lets you log and keep track of the amount of Japanese
                    cards you have from the Magic The Gathering set 
                    Strixhaven: Mystical Archives! Please log in or create an account
                     to view profiles and log cards!</h3>
                <?php
                    endif;
                ?>
            </div>
