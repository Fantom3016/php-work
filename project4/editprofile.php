        ...
        <div class="card">
                ...
                <?php
                    ...
                    if (isset($_GET['id_to_edit'])) {
                        ...
                        $query = "SELECT * FROM player WHERE id = $id_to_edit";
                        $result = mysqli_query($dbc, $query)
                            or trigger_error('Error querying database player', E_USER_ERROR);
                        ...
                        if (mysqli_num_rows($result) == 1) {
                            ...
                            $query = "UPDATE player SET user_name = '$user_name',"
                            ...
                            mysqli_query($dbc, $query)
                                or trigger_error(
                                'Error querying database player: Failed to update player listing',
                                E_USER_ERROR
                                );
